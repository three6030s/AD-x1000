...
export function replicantiGalaxy(auto) {
  ...
  Replicanti.amount = PelleUpgrade.replicantiGalaxyEM40.canBeApplied ? Replicanti.amount
    : Achievement(126).isUnlocked && !Pelle.isDoomed
...
function fastReplicantiBelow308(log10GainFactor, isAutobuyerActive) {
  ...
  Replicanti.amount = PelleUpgrade.replicantiGalaxyEM40.canBeApplied
  ?  Decimal.pow10(replicantiExponent)
